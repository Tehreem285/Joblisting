...
const Joblistings = () => {
 ...
 const [lastDoc, setLastDoc] = useState(null);
  ...
  // Check if filters/sorting applied
  const hasFilters =
    title !== "" ||
    jobType !== "" ||
    location !== "" ||
...
// ✅ Fetch Jobs (used for first load + filters + load more)
...
// ✅ Apply filters (just calls loadJobs with reset)
const applyFilters = () => {
  setLastDoc(null);
  setHasMore(true);
  loadJobs(false); // reset + fetch new
};
